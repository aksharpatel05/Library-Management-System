...
void employee::search_em()
{
    ...
    cout<<endl<<"\t\tEnter Code Of the Employee..........: ";
    cin>>code;
    for(i=0;i<num+n;i++)
        if(emp[i].code==code)
        {
                cout<<"\t\t\t"<<"    EMPLOYEE NAME       "<<"JOB CODE     "<<"    DESIGNATION     "<<"EXPERIENCE  "<<"AGE"<<endl;
                cout<<"\t\t\t"<<"----------------------------------------------------------------------------"<<endl;
...
void employee::edit_em()
{
    ...
    char x;
    system("cls");
    cout<<"\n\n\n\t\tEdit An Entry"<<endl<<"\t\tEnter the JobCode To Edit that Entry.........: ";
    cin>>code;
    for(i=0;i<num+n;i++)
        if(emp[i].code==code)
            break;
...
void employee::delete_em()
{
    long int code;
    system("cls");
    cout<<"\n\n\n\t\tDelete an Entry"<<endl<<"\t\tEnter the JobCode To Delete that Entry........: ";
    cin>>code;
    for(i=0;i<num+n;i++)
        if(emp[i].code==code)
            break;
...
void menu()
{
    system("cls");
    char x;
    cout<<endl<<"\n\n\t\t\t\t*****  Employee Management System 1.0.1 ***** ";
